...
type Goods struct {
	...
	XgDate        *timestamp.Timestamp `protobuf:"bytes,22,opt,name=XgDate,proto3" json:"XgDate,omitempty"`
	LrDate        *timestamp.Timestamp `protobuf:"bytes,23,opt,name=LrDate,proto3" json:"LrDate,omitempty"`
...
func (m *Goods) GetXgDate() *timestamp.Timestamp {
	if m != nil {
		return m.XgDate
	}
	return nil
...
func (m *Goods) GetLrDate() *timestamp.Timestamp {
	if m != nil {
		return m.LrDate
	}
	return nil
...
type ListQuery struct {
	...
	XgDate string `protobuf:"bytes,4,opt,name=XgDate,proto3" json:"XgDate,omitempty"`
}
...
func (m *ListQuery) GetXgDate() string {
	if m != nil {
		return m.XgDate
	}
	return ""
...
var fileDescriptor_42ff7bf58be59df1 = []byte{
	...
	,
}
...
func (m *Goods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LrDate != nil {
		{
			size, err := m.LrDate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.XgDate != nil {
		{
			size, err := m.XgDate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Goods) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			...
			if m.XgDate == nil {
				m.XgDate = &timestamp.Timestamp{}
			}
			if err := m.XgDate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 23:
			...
			if m.LrDate == nil {
				m.LrDate = &timestamp.Timestamp{}
			}
			if err := m.LrDate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 24:
